<section class="bg-secondary">
    ...
    <section class="bg-secondary ">
        <div class="mx-auto max-w-screen-xl px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
            <h2 class="text-center text-4xl font-bold tracking-tight text-neutralDark sm:text-5xl">
                Apa yang dikatakan oleh staff kami
            </h2>

            <div class="mt-8 [column-fill:_balance] sm:columns-2 sm:gap-6 lg:columns-3 lg:gap-8 [mask-image:radial-gradient(ellipse_80%_80%,#000_60%,transparent_100%)]">
                <div class="mb-8 sm:break-inside-avoid">
                    <blockquote class="rounded-l p-6 shadow-xs sm:p-8 bg-neutralGray2">
                        <div class="flex items-center gap-4">
                            ...
                            <div>
                                ...
                                <p class="mt-0.5 text-lg font-medium text-neutralDark">Paul Starr</p>
                            </div>
                        </div>

                        <p class="mt-4 text-neutralDark">
                ...
                <div class="mb-8 sm:break-inside-avoid">
                    <blockquote class="rounded-lg bg-neutralGray2 p-6 shadow-xs sm:p-8">
                        <div class="flex items-center gap-4">
                            <img
                                alt=""
                                src="https://images.unsplash.com/photo-1595152772835-219674b2a8a6?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1180&q=80"
