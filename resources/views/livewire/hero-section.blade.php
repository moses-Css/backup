<section
        class="min-h-full   text-neutralDark text-center bg-secondary dark:bg-neutralDark  bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] dark:bg-[radial-gradient(#E6E6EB_1px,transparent_1px)] [background-size:16px_16px] ">
        <div class="px-10 pb-24 pt-12">
            <div class="w-full items-center mx-auto ">
                ...
                <h1 class="text-5xl xl:text-7xl font-medium dark:text-secondary inline-block">Galeri Digital BBKBN</h1>
                <p class="mt-2 text-sm text-neutralGray md:text-lg">Platform resmi untuk mengelola, menyimpan, dan mengakses foto
                    dokumentasi BKKBN dengan mudah, aman, dan terstruktur.</p>
            </div>
