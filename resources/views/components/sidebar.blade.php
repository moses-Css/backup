<aside id="sidebar" class="h-screen w-64 p-6 fixed flex flex-col transition-transform -translate-x-full sm:translate-x-0 border-r z-10 bg-secondary">
    ...
    active:scale-[0.98] active:shadow-none flex items-center justify-center gap-2 ">
        ...
        <x-slot name="content">
            <x-dropdown-link href="#" @click.prevent="$dispatch('open-modal', { modal: 'kategori-modal' })">
                {{ __('Kategori') }}
            </x-dropdown-link>
    ...
    <nav class="space-y-1 flex-1">
        ...
        <div class="border-l pr-2">
            ...
            <x-sidebar-link :href="route('log')" wire:navigate route="log" icon="log"> Log </x-sidebar-link>
    ...
    <div class="mt-auto flex-row items-center my-auto space-y-4  ">
        ...
        <x-sidebar-link icon="wrench">Backup</x-sidebar-link>
    </div>
